...
void paths(int i, int j, vector<vector<char>> &grid, int &steps, int &cnt_one, int &cnt_zero){
...
void solve() {
  ...
  fr(i,0,n-1) { 
   ...
   trav(e, ones){
       ...
       paths(e.fi, e.se, grid, steps, cnt_one, cnt_zero);
