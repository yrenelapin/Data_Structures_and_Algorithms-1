...
// This maintains the number of the SCC
int counter = 1;
...
// add edges to form the inverse graph [ Called as Transponse Graph in CP Algorithms Website ]
...
int main()
{
	...
	// For m clauses, we have a[m], b[m] representing ( a[i] or b[i] )
...
// Ref: https://www.geeksforgeeks.org/2-satisfiability-2-sat-problem/