...
If the variable is not declared either in the same function or completely outside all the functions, It creates error even if we defined that function in some other function...
