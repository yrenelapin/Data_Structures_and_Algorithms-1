...
/*
get_integer :- This function takes input from the user and returns int if user inputs int. 
...
int get_integer(){
    ...
    while( c != '\n' ){
        ...
        if ((i<=9) && (i >=0)) {num = num*10 + i;}       // Checks for Integers and finds the entire number.
...
/*
calculate:- This function takes 2 Int inputs and 1 operator form +,-,/,* and does the computation between those two Integers
...
int main(){
    ...
    printf("\nAnswer = %0.2f", calulate(n1,n2,oper));
    printf("\n\nBye!");
    printf("\n-------------------");
