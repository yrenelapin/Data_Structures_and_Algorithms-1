...
/* 
The following line tells the complier that a function called square will be defined later and the function takes an Int as 
Input and outputs an Int again.
...
// We need to define the type of value returned by the function always.
...
// In general any combinations of Input and Output are Possible between int and float
...
// Execution of functions defined starts inside this main() function.
int main(){
