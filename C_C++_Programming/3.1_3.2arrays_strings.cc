...
void printarrayelement(int array[]){
    ...
    // Even Inside function we can try to access the elements outside the range like i.e Though ar has only
    // 5 elements (till ar[4]), ar[5] or ar[6],.... are also accessible and they possess a random value that is generated by C compiler
...
int main(){
    ...
    int ar1[5]= {1,2,3,4,5} ;
    //Though ar1 has only 5 elements (till ar[4]), ar[5] or ar[6],.... are also accessible and they possess a random value 
    //that is generated by C compiler
    ...
    // int i =12; // Since length of string is equal to 12 (Indices exist till 11)
    // int num = str[i];
    ...
    // But array of single characters (Ex:- chr) will not have end i.e End of String chr is not added. So, It keeps
    // on printing all characters from its memory. 
...
// %s -->String
// Note that string is a sequence of Characters 
